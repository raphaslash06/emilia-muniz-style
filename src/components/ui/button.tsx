  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gradient-to-r from-gold to-gold-light text-secondary font-semibold tracking-wide shadow-[0_4px_20px_hsl(45_85%_45%/0.3)] hover:shadow-lg hover:scale-105 border-0",
        "gold-outline": "border-2 border-gold bg-transparent text-gold hover:bg-gold hover:text-secondary font-semibold tracking-wide",
        elegant: "bg-secondary text-secondary-foreground hover:bg-charcoal border border-gold/20 hover:border-gold/50",
      },
      size: {
